    ...
    @guest('customer')
      <div class="w-max">
        <div class="border-on-surface/8 border-b px-4 py-3">
          <p class="text-lg font-semibold" {{ $block->liveUpdate()->text('guest_heading') }}>
            {{ $block->settings->guest_heading }}
          </p>
          <div class="text-on-surface/80 prose prose-sm mt-1 text-sm" {{ $block->liveUpdate()->html('guest_description') }}>
