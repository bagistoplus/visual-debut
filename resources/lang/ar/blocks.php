...
return [
    ...
    'header-nav' => [
        ...
        'settings' => [
            ...
            'categories_info' => 'حدد الفئات التي ستظهر في تنقل الرأس. اتركه فارغًا لاستخدام الفئات الجذرية.',
            'category_limit_label' => 'حد الفئات',
            'category_limit_info' => 'الحد الأقصى لعدد الفئات المعروضة.',
        ],
    ],
